// server.js - Updated with booking management routes
...
app.use('/api/booking-management', bookingManagementRoutes); // NEW ROUTE
...
initializeDatabase()
  .then(async () => {
    ...
    app.listen(PORT, () => {
      ...
      console.log(`   Booking management: /api/booking-management`); // NEW
